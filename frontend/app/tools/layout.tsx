...
export default function ToolsLayout({
  ...
  const jsonLd = {
    ...
    "@type": "WebApplication",
    "name": "Tika Joshi Free Online Tools",
    "url": "https://www.tikajoshi.com.np/tools",
    "description": "Free online tools for Nepali students — PDF merge/convert, image compressor, QR generator, voice to text, TU result checker.",
