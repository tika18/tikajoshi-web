  ...
  return (
    <div className="min-h-screen bg-[#020817] text-white">
      ...
      <div className="pt-32 px-6 max-w-3xl mx-auto text-center">
        ...
        {/* ── SEO CONTENT BLOCK ── */}
        <div className="mt-12 bg-white/[0.02] border border-white/[0.06] p-8 rounded-3xl text-left">
          <h2 className="text-xl font-bold text-white mb-4">How to Generate a QR Code for Free</h2>
          <div className="space-y-4 text-sm text-slate-400 leading-relaxed">
            <p>
              <strong className="text-slate-300">Fast & Free QR Code Generator:</strong> Instantly create QR codes for website URLs, text messages, Wi-Fi passwords, and more. Our tool generates high-quality QR codes that never expire.
            </p>
            <p>
              <strong className="text-slate-300">Why use QR Codes?</strong> QR codes bridge the gap between physical and digital spaces. Use them on business cards, menus, or marketing materials to allow users to scan and access your digital content in seconds.
            </p>
          </div>
        </div>
      </div>
