  ...
  return (
    <div className="min-h-screen pt-24 pb-12">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        {/* ── SEO CONTENT BLOCK ── */}
        <div className="mt-12 bg-white/[0.02] border border-white/[0.06] p-8 rounded-3xl">
          <h2 className="text-xl font-bold text-white mb-4">Why Compress Images Online?</h2>
          <div className="space-y-4 text-sm text-slate-400 leading-relaxed">
            <p>
              <strong className="text-slate-300">Free Image Compressor:</strong> Reduce image file sizes by up to 95% without noticeable quality loss. Fast, secure, and processing happens directly in your browser. No images are uploaded to any server.
            </p>
            <p>
              <strong className="text-slate-300">How to use:</strong> Simply drag and drop your JPG, PNG, or WEBP image into the upload area. Adjust the compression strength slider to balance file size and quality, then click Download. Perfect for optimizing images for websites to improve SEO and load speeds.
            </p>
          </div>
        </div>
      </div>
